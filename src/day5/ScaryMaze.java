...
int background = -1;
		...
		else if (mouseColor == -16579326) {
		JOptionPane.showInputDialog(null, "NICE, YOU WON! Type in feedback");
		JOptionPane.showMessageDialog(null, "Cool Thanks!");
		}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("A.wav"));
	...
	private void showScaryImage(String imageName) {
		try {
			maze = ImageIO.read(getClass().getResource("S.jpg"));
		} catch (Exception e) {
